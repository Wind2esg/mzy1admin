...
<template>
    <Card class="intention-apply">
        ...
        <Page :total="total" :page-size="pageSize" show-sizer placement="top" :page-size-opts="[5,10,15,20,25,30]" @on-page-size-change="pageSizeChange" @on-change="pageChange"  v-if="!editVisible"></Page>
...
export default {
    ...
    methods: {
        getData(bol){
            ...
            this.$request(this.$api.CompanyNoticeList, params, data=>{
        ...
        changeOpen(record){
            ...
            this.$request(this.$api.CompanyNoticeOpen, params, data=>{
                setTimeout(()=>{
                    this.getData(true)
                }, 200);
            })
        ...
        deleteData(record){
            ...
            this.$request(this.$api.CompanyNoticeDelete, params, data=>{
                if (data.isSuccess){
