<template>
    <div class="applay-manage">
        ...
        <div class="network-change-language">
              <div style="font-size:20px">申请管理</div>
<!-- 
         ...
         <Select v-model="model1" style="width:200px;margin:20px 20px 20px 20px" clearable>
    ...
    export default{
        ...
        methods:{
            ...
            GetJoinUsList(){
                ...
                this.$request(this.$api.GetJoinUsList,lists,data=>{
                    this.total=data.key;
            ...
            deleteList(record){
               ...
               this.$request(this.$api.DeleteJoinUs,delet,data=>{
                     if(data.isSuccess){
            ...
            markList(record){
                ...
                this.$request(this.$api.LookJoinUs,mark,data=>{
                    if(data.isSuccess){
                        this.$Message.success(data.message);
                        this.GetJoinUsList();
                    }else{
