  ...
  <Card class="agent_information intention-apply" v-if="!visible">
    ...
    <div class="manage_box">
      ...
      <div class="network-change-language">
        ...
        <span v-for="list in listsEnglish" :key="list.id" @click="tabsChange(list)" class="change-tab" :class="{'change-tab-action':actionIndex==list.id}">{{list.value}}
        </span>
      ...
      <div class="search">
        ...
        <Select v-model="type" class="selectType" placeholder="所属系列" style="width:160px;">
...
<script>
    ...
    import productManage from './components/specialty-product-details.vue';
...
export default {
    ...
    methods: {
        ...
        getType(){
            this.$request(this.$api.PcProductTypeProfession, {IsChanese:this.actionIndex}, data => {
        ...
        getList(bol){
            ...
            this.$request(this.$api.PcProductProfession, params, data => {
        ...
        changeState(record){
            ...
            this.$request(this.$api.PcProductProfessionState, params, data => {
        ...
        deleteData(record){
            console.log(record);
            this.$request(this.$api.PcProductProfessionDelete, {Id: record.id}, data => {
                if (data.isSuccess){
