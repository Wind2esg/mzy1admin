    ...
    methods: {
        ...
        saveData(){
            ...
            const params = {
              ...
              SpeValue: this.formInfo.rules,
              ProductType: this.formInfo.productType,
            ...
            this.$request(this.$api.PcProductProfessionUpdate, params, data => {
                if (data.isSuccess){
  ...
  watch: {
    visible(value) {
      ...
      if(value){
        ...
        if(this.formInfo.wapPng) {
            this.wapPng = this.imghost + this.formInfo.wapPng;
        }else {
            this.wapPng = 'http://cdn.xiaojiankeji.com/images/other/default-img.png';
        }
