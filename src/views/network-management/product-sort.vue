<template>
    <div class="product-sort">
        ...
        <div class="network-change-language">
          <div style="font-size: 20px">产品分类</div>
        ...
        methods:{          
            ...
            saveBtn(){
                ...
                let palamers={
                    ...
                    EnglishName:this.lists.englishName  || '',
                    Describe:this.lists.describe || '' , 
                    IsChanese:this.actionIndex                   
                }

                this.$request(this.$api.updateProudctType,palamers,data=>{
                    if(data.isSuccess){
            ...
            deleteProduct(recods){
                ...
                this.$request(this.$api.DeleteProudctType,palamers,data=>{
                    if(data.isSuccess){
            ...
            changeState(recorder){
                ...
                this.$request(this.$api.changeProudctTypeState,state,data=>{
                    if(data.isSuccess){
            ...
            saveSerise(){
              ...
              this.$request(this.$api.EditSeriesDescription,servers,data=>{
                  if (data.isSuccess){
                        this.$Message.success('修改成功!');
                        this.getList();
                         this.modal3=false;
