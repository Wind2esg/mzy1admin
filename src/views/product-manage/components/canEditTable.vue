...
const cellInput = (vm, h, param, item) => {
    ...
    if ( ['specCount', 'maxCount', 'minCount'].indexOf(param.column.key) > -1 ){
...
export default {
    ...
    methods: {
        init () {
            ...
            let cloneData = JSON.parse(JSON.stringify(this.lmlValue));
            let res = [];
